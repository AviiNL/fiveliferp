...
namespace FiveLife.NativeUI
{
    ...
    public class MenuPool
    {
        ...
        /// <summary>
        /// Get the menu by it's class name as a string
        /// </summary>
        /// <param name="ClassName"></param>
        /// <returns></returns>
        public UIMenu this[string ClassName] {
            get {
                return _menuList.SingleOrDefault(x => x.GetType().Name == ClassName);
            }
        }
        ...
        {
            _menuList.RemoveAll(x => x.GetType() == menu.GetType());
            _menuList.Add(menu);
            RefreshIndex();
        }

        /// <summary>
        /// Clears all menu's from the menu pool.
        /// </summary>
